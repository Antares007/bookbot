...
const elm = (tag, piths, key) => new ElmT(tag, (piths instanceof S.S ? piths : S.at(piths)).map(x => x instanceof PithT ? x : pith(x)), key);

exports.elm = elm;

const str = texts => new StrT(texts instanceof S.S ? texts : S.at(texts));
